...
export const knownLocationIds: string[] = ["us-tx-001", "us-fl-001", "us-ga-001"];
...
export const getClinicianFullName = (clinician: Clinician): string =>
  `${clinician.firstName} ${clinician.lastName}`;

export const isDeniedClaim = (claim: Claim): boolean => claim.status === "denied";

export const isNoShowAppointment = (appointment: Appointment): boolean =>
