"""Database setup for Incidents API — TinyDB backend."""
...
DEFAULT_DB_PATH = Path(__file__).resolve().parents[2] / "data" / "process" / "incidents_db.json"

_db: TinyDB | None = None


def get_db_path() -> Path:
    raw_path = os.getenv("INCIDENTS_DB_PATH")
